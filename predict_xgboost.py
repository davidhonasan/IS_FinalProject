...
# x_test['predicted_sma'] = y_predicted
X_test['prediction'].iloc[0] = X_test['close'].iloc[0] + y_predicted[0]
# x_test['sum'] = x_test['close'] + y_predicted
...
plt.subplot(2,1,2)
plt.plot(xgbModel.evals_result()['validation_0']['rmse'])
plt.plot(xgbModel.evals_result()['validation_1']['rmse'])
